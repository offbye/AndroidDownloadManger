        ...
        switch (v.getId()) {
            case R.id.download_add:
                DownloadTask downloadTask = new DownloadTask(
                        "http://apache.etoak.com/ant/ivy/2.3.0-rc1/apache-ivy-2.3.0-rc1-src.zip",SDCARD,"apache-ivy.zip","apache-ivy.zip",null);
            ...
            case R.id.download_add2:
                DownloadTask downloadTask2 = new DownloadTask(
                        "http://mirror.bjtu.edu.cn/apache/axis/axis2/java/core/1.6.2/axis2-eclipse-service-plugin-1.6.2.zip",SDCARD,"axis2.zip","axis2.zip",null);
            ...
            case R.id.download_add3:
                DownloadTask downloadTask3 = new DownloadTask(
                        "http://flv1.vodfile.m1905.com/movie/1209/120904A8CD8E096BBD237F.flv",null, "就是闹着玩的.flv","就是闹着玩的.flv",null);
            ...
            case R.id.download_add4:
                DownloadTask downloadTask4 = new DownloadTask(
                        "http://mmsvideopublic1.m1905.com/1209/12090396423D16DAA769B0.flv",SDCARD,"6DAA769B0.flv","伊能静谈及新片欲“投诉”",null);
            ...
            case R.id.download_add5:
                DownloadTask downloadTask5 = new DownloadTask(
                        "http://mmsvideopublic1.m1905.com/1209/120927A964F8A819E2B963.flv",SDCARD,"9E2B963.flv","《白鹿原》艰难登顶 整体萎靡国庆发力",null);
            ...
            case R.id.download_add6:
                DownloadTask downloadTask6 = new DownloadTask(
                        "http://mirror.bit.edu.cn/apache/empire-db/2.3.0/apache-empire-db-2.3.0-dist.zip",SDCARD,"axis6.zip","axis6.zip",null);
